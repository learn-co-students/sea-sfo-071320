...
Player.create(name: "lisa")
Player.create(name: "emma")
Player.create(name: "rick")
Player.create(name: "brad")
Player.create(name: "morty")

GamesPlayer.create(player_id: 1, game_id: 1)
GamesPlayer.create(player_id: 1, game_id: 2)
GamesPlayer.create(player_id: 1, game_id: 3)
GamesPlayer.create(player_id: 1, game_id: 4)
GamesPlayer.create(player_id: 1, game_id: 5)
GamesPlayer.create(player_id: 2, game_id: 3)
GamesPlayer.create(player_id: 2, game_id: 4)
GamesPlayer.create(player_id: 3, game_id: 1)
GamesPlayer.create(player_id: 3, game_id: 2)
